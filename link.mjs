...
const symlinkPath = path.resolve(dataPath, "modules", "pf2e-avatars");
...
if (symlinkStats) {
    ...
    const proceed = (
        await prompts({
            ...
            name: "value",
            initial: false,
            message: `A "pf2e-avatars" ${atPath} already exists in the "systems" subfolder. Replace with new symlink?`,
        })
    ).value;
    if (!proceed) {
